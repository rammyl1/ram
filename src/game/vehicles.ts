...
export type VehicleType = "car" | "bus" | "tricycle" | "truck";
...
const VTYPES: VehicleType[] = ["car","car","car","bus","tricycle","truck","car","car","tricycle"];
...
export function createInitialVehicles(): Vehicle[] {
  ...
  H_ROADS.forEach((road, ri) => {
    ...
    const positions = spreadVehicles(count, spread, road.dir, 130, ri * 60);
    for (let i = 0; i < count; i++) {
